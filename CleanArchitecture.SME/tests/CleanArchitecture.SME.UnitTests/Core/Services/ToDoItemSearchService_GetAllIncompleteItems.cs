...
using CleanArchitecture.SME.Core.ProjectAggregate;
using CleanArchitecture.SME.Core.Services;
using CleanArchitecture.SME.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace CleanArchitecture.SME.UnitTests.Core.Services
{
