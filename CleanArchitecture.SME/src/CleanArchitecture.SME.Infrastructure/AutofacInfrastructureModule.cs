...
using CleanArchitecture.SME.Infrastructure.Data;
using CleanArchitecture.SME.Infrastructure.Data.Queries;
using CleanArchitecture.SME.Infrastructure.Email;
using CleanArchitecture.SME.UseCases.Contributors.Create;
using CleanArchitecture.SME.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace CleanArchitecture.SME.Infrastructure;
